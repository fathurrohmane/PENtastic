...
public class LevelSelectScreen1 implements Screen {
...
InputHandler touch;
	...
	public LevelSelectScreen1(PENtasticMain main) {
		this.main = main;
		initiation();
	}
	...
	public void render(float delta) {
		...
		Font1_1.draw(batch,"1.1", Rect1_1.x +(Font1_1.getBounds("1.1").width / 2) + 10, Rect1_1.y + Font1_1.getBounds("1.1").height * 2);
	...
	public void initiation(){
		...
		texturePath = new Texture(Gdx.files.internal(Constant.resolution+"/menu/levelSelect/sublevel path.png"));
		...
		texturePath2 = new Texture(Gdx.files.internal(Constant.resolution+"/menu/levelSelect/sublevel2 path.png"));
